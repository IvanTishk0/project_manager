    ...
    return (
        <Container className="registration-form-container bg-dark">
            <Form onSubmit={handleSubmit}>
                ...
                <Button disabled={loading || emailExists || !passwordsMatch}
                        className="submit-button rounded-3"
                        variant="dark" type="submit"

                >
                    Зарегистрироваться
                </Button>
                <p className="link-text">Уже есть аккаунт? <a href="/login" onClick={handleNavigation}>Aвторизируйтесь</a></p>
            </Form>
        </Container>
    );
};
